      ...
      <div className="header">
        ...
        <div className="header-icon">
          <Link to="/Cart" className="header-cart">
            <p className="addCartItem">{size}</p>
      ...
      <div className={`responsive-nev ${burgerMenu}`}>
        <div className="menu">
          <div className="resp-menu">
            <Link to="/" className="responsive-nev-link">
              HOME
            </Link>
          </div>
          <div className="resp-menu">
            <Link to="/About" className="responsive-nev-link">
              About
            </Link>
          </div>
          <div className="resp-menu">
            <Link to="/Contact" className="responsive-nev-link">
              Contact
            </Link>
          </div>
          <div className="resp-menu">
            <Link to="/Cart" className="responsive-nev-link">
              Cart
            </Link>
          </div>
        </div>
